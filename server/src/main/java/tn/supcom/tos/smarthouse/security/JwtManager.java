package tn.supcom.tos.smarthouse.security;
...
public class JwtManager {
    ...
    private final Set<String> audiences = Set.of("urn:me.smarthomecot.www","urn:me.smarthomecpt.admin","urn:me:smarthomecot:api");
    private final String issuer = "urn:me.smarthomecot.iam";
